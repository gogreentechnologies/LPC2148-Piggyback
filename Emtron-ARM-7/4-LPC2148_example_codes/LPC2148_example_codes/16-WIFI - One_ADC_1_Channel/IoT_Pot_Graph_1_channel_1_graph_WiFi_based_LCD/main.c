...
void generateApi(int adcVal1)
{ adcVal1=(adcVal1/4);
	sprintf(api,"GET /update?api_key=1AHY99PU383SN8QF&field1=%4d HTTP/1.0\r\nHost:api.thingspeak.com\r\n\r\n",adcVal1);
}
...
int main(){
	...
	while(1)// continuously runs this bloock
		...
		val1 = adc_read(ADC0,CHANNEL_1);
		//val2 = adc_read(ADC0,CHANNEL_2);
		sprintf(adc,"%3d",val1);
		generateApi(val1);
